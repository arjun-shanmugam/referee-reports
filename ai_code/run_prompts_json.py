...
class ChatLLM:
    ...
    def chat(self, message, json_file):
...
def run_parametric_series_prompts(train_json, test_json):
    ...
    # prompt 1
    chat.run_prompt("../prompts/prompt1.txt", train_json, output_file = "../llm outputs/prompt1_scores.txt")

    # prompt 2
    chat.run_prompt("../prompts/prompt2.txt", test_json, output_file = "../llm outputs/prompt2.txt")

    # prompt 3
    chat.run_prompt("../prompts/prompt3.txt", test_json, output_file = "../llm outputs/prompt3.txt")
