...
UNIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/NR_over_NP/ridge/unigrams/"
BIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/NR_over_NP/ridge/bigrams/"
TRIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/NR_over_NP/ridge/trigrams/"
...
regularized_regress_on_entire_vocabulary(pickled_papers=PICKLED_PAPERS,
                                         ...
                                         y='_female_',
                                         model_names=["Unigram Ridge on NR over NP", "Bigram Ridge on NR over NP", "Trigram Ridge on NR over NP"],
                                         method='ridge',
                                         logistic=True,
                                         standardize=True,
...
UNIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/NR_over_NP/ridge/unigrams_placebo/"
BIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/NR_over_NP/ridge/bigrams_placebo/"
TRIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/NR_over_NP/ridge/trigrams_placebo/"
regularized_regress_on_entire_vocabulary(pickled_papers=PICKLED_PAPERS,
                                         pickled_reports=PICKLED_REPORTS,
                                         output_paths=[UNIGRAMS_OUTPUT, BIGRAMS_OUTPUT, TRIGRAMS_OUTPUT],
                                         seed=7,
                                         ...
                                         y='_female_',
                                         model_names=["Unigram Ridge on NR over NP (Placebo)",
                                                      "Bigram Ridge on NR over NP (Placebo)",
                                                      "Trigram Ridge on NR over NP (Placebo)"],
                                         method='ridge',
                                         logistic=True,
                                         standardize=True,
                                         log_transform='plus_one',
