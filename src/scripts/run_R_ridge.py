...
UNIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/R/ridge/unigrams/"
BIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/R/ridge/bigrams/"
TRIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/R/ridge/trigrams/"

# Run ridge regressions of referee gender on R.
...
regularized_regress_on_entire_vocabulary(pickled_papers=PICKLED_PAPERS,
                                         ...
                                         y='_female_',
                                         model_names=["Unigram Ridge on R", "Bigram Ridge on R", "Trigram Ridge on R"],
                                         method='ridge',
                                         logistic=True,
                                         standardize=True,
...
UNIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/R/ridge/unigrams_placebo/"
BIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/R/ridge/bigrams_placebo/"
TRIGRAMS_OUTPUT = "/data/home/ashanmu1/Desktop/refereebias/output/R/ridge/trigrams_placebo/"
regularized_regress_on_entire_vocabulary(pickled_papers=PICKLED_PAPERS,
                                         pickled_reports=PICKLED_REPORTS,
                                         output_paths=[UNIGRAMS_OUTPUT, BIGRAMS_OUTPUT, TRIGRAMS_OUTPUT],
                                         seed=7,
                                         ...
                                         y='_female_',
                                         model_names=["Unigram Ridge on R (Placebo)",
                                                      "Bigram Ridge on R (Placebo)",
                                                      "Trigram Ridge on R (Placebo)"],
                                         method='ridge',
                                         logistic=True,
                                         standardize=True,
                                         log_transform='plus_one',
